...
class SpiderMain(object):
    ...
    def craw(self,root_url,root_user_url,root_name_all):
        for root_name_single in root_name_all:
            ...
            if domain_rank != -1:
                print "关键词：%s\t百度排名为： %d" % (root_name_single,domain_rank)
            else:
                print "关键词：%s\t百度排名50名之外" % root_name_single

if __name__ == '__main__':
    root_name = ['长沙消防工程公司','消防工程安装公司','长沙安防工程','长沙智能化弱电工程']
    ...
    obj_spider.craw(root_url,root_user_url,root_name)